...
public class CheckoutPage extends Utility {
    ...
    public void enterBillingDetails() throws InterruptedException {
        ...
        sendTextToElement(email, "Sitaram"+getRandomAlphaNumericString(4)+"@gmail.com");
        sendTextToElement(telephone, "07564373347");
        sendTextToElement(address, "97,Craven Road");
        sendTextToElement(city, "Paddington");
        sendTextToElement(postCode, "W24TY");
