...
public class LaptopsAndNoteBooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        Assert.assertEquals(macBookPage.getTextFromMacBook(), "MacBook", "MacBook Product is not display");
        ...
        Assert.assertEquals(shoppingCartPage.getTotalText(), "$1,204.00", "Total is not matched");
        //2.15 Click on “Checkout” button
        shoppingCartPage.clickOnCheckout();
        //2.16 Verify the text “Checkout”
        Thread.sleep(1000);
        Assert.assertEquals(checkoutPage.getCheckoutText(), "Checkout", "Checkout is not displayed");
        //2.17 Verify the Text “New Customer”
        Thread.sleep(1000);
        Assert.assertEquals(checkoutPage.getNewCustomerText(), "New Customer", "New Customer is not displayed");
        ...
        Assert.assertTrue(checkoutPage.isPaymentWarningAppearing(), "Payment Warning is not displayed");
    }
}
