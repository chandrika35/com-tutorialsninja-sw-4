...
public class TopMenuTest extends BaseTest {
    ...
    public void verifyUserShouldNavigateToDesktopsPageSuccessfully() {
       ...
       Assert.assertEquals(actualDesktop, expectedDesktop, "Desktop is not displayed");
    }
    ...
    public void verifyUserShouldNavigateToLaptopsAndNotebooksPageSuccessfully() {
        ...
        //verify if user is navigated to the correct page
        Assert.assertEquals(actualLaptopsAndNotebooks, expectedLaptopsAndNotebooks, "Laptops And Notebooks are not displayed");
    }
    ...
    public void verifyUserShouldNavigateToComponentsPageSuccessfully() {
        ...
        //verify if user is navigated to the correct page
        Assert.assertEquals(actualComponents, expectedComponents, "Components Page is not displayed");
    }
}
